...
char dept[6][20] = {"RRHH", "Consultoria", "Dise�o", "Producci�n", "Calidad", "Distribuci�n"};
...
int consulta_cedula(int cedula){
    ...
    fclose(archivo);
    printf("\n�La CI indicada no est� asociada a ning�n trabajador de la empresa!\n");
    return 0;
}
        ...
        if(((archivo = fopen("trabajadores.in", "w")) == NULL)||(archivof = fopen("extrabajadores.txt", "a+")) == NULL){
            ...
            if((strcmp(confirmacion,"si")==0)&&(re_menu==0)){ //codicional para continuar con la eliminacion
                ...
                if (numero < 1 || numero > 6){
                    printf("El n�mero no corresponde a ninguna Eliminacion!\nIntente de nuevo: ");
                    }
                    ...
                    switch (op){
                        ...
                        case 3:
                            ...
                            do{
                                ...
                                numero = atoi(val);
                                if (numero < 1 || numero > 6)
                                    printf("El n�mero no corresponde a ning�n departamento!\nIntente de nuevo: ");
    ...
    if((arch = fopen("trabajadores.in", "a+")) == NULL){
        ...
        do {
            ...
            do{
                ...
                numero = atoi(val);
                if (numero < 1 || numero > 6)
                    printf("El n�mero no corresponde a ning�n cargo!\nIntente de nuevo: ");
            }while(numero < 1 || numero > 6);
